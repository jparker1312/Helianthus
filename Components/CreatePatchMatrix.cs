...
{
  public class CreatePatchMatrix : GH_Component
  {
    ...
    /// </summary>
    public CreatePatchMatrix()
      : base("CreatePatchMatrix",
             "Create Patch Matrix",
             "Create patch matrix using gendaymtx",
             "Helianthus",
             "02 | Analyze Data")
    {
    }
    ...
    protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
    {
        ...
        pManager.AddGeometryParameter("SurfaceGeometry", "Surface Geometry",
            "Rhino Surfaces or Rhino Meshes", GH_ParamAccess.item);
    ...
    {
      get { return new Guid("b89887d9-67a5-45db-8ddb-23d561fe728a"); }
    }
  }
}
